/*
 * 项目名称:platform-plus
 * 类名称:QkjrtsWelfareMemberDao.java
 ...
 */
@Mapper
public interface QkjrtsWelfareMemberDao extends BaseMapper<QkjrtsWelfareMemberEntity> {
     ...
     * @return List
     */
    List<QkjrtsWelfareMemberEntity> queryAll(@Param("params") Map<String, Object> params);
     ...
     * @return List
     */
    List<QkjrtsWelfareMemberEntity> selectQkjrtsWelfareMemberPage(IPage page, @Param("params") Map<String, Object> params);
